...
escola = server.api('Escola', {
    ...
    'tipo': fields.String(description='Tipo da escola: 1 - urbana, 2 - rural', required=True),
    'dependencia': fields.String(description='Tipo de dependência da escola', required=True),
